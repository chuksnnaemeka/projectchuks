...
<div id="insuredbox" align="center" style=" background:">
    ...
    <img src="images/step1.jpg" width="100" height="100"><br/>
    ...
    <span class="cbn">SPONSORED BY HUAWEI</span>
     ...
     <div id="terms-how">
       <p>HOW IT WORKS
     What you can resell with PayStadia.com</p>
       <p>1. Buy Artime         </p>
       <p>2. Make payment for Mobile Data plan (Internet subscription) across all networks.         </p>
       <p>3. Cable TV subscription payment - e.g DSTV, GOTV, Startimes and other digital TV Services.         </p>
       <p>4. Elecricity Bills (Utilities) payment for both Prepaid and Postpaid meters.         </p>
       <p>5. Purchase WAEC pins and lots more. </p>
     </div><!----- TERMS div close---->
