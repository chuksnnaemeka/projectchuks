...
<nav class="navbar navbar-default navbar-fixed-top" style=" height:80px; background:#036;">
  <div class="container" >
...
<div style=" height:80px; background:rgb(255, 0, 0,5);">
gffgfg
...
<!-----------------main LMAIN close---->
    ...
    <span class="howtext" style="display:block;">Services  </span>
    <div id="leftser" style=" ">
    <p></p>
    <div id="leftser2" style=" ">
    Account<br/>
    <div class="form-group">
    
      <input type="text" class="form-control" placeholder="Full Name" name="emailaddress" value="" required />
    </div>
    ...
    <div id="rightser" align="center">
    
  
    <span class="row text-center slideanim">
<div class="serbox"><img src="images/block1.png" width="100%" height="100%" class="ICONWRAPPRER"/></div>
     <div class="serbox"><img src="images/block2.png" width="100%" height="100%" class="ICONWRAPPRER"/></div>
      <div class="serbox"><img src="images/block3.png" width="100%" height="100%" class="ICONWRAPPRER"/></div>
       <div class="serbox"><img src="images/block4.png" width="100%" height="100%" class="ICONWRAPPRER"/></div>
     
     <div class="clear"></div> 
     
 
     <div class="serbox"><img src="images/block5.png" width="100%" height="100%" class="ICONWRAPPRER"/></div>
     <div class="serbox"><img src="images/block6.png" width="100%" height="100%" class="ICONWRAPPRER"/></div>
      <div class="serbox"><img src="images/block7.png" width="100%" height="100%" class="ICONWRAPPRER"/></div>
       <div class="serbox"><img src="images/block8.png" width="100%" height="100%" class="ICONWRAPPRER"/></div>
        </span>
     <div class="clear"></div>
 ...
 <p  class="typewrite" data-period="2000" data-type='[ "Hi, Im VipulM.", "I am Creative.", "<strong>I Love Design</strong>.", "I Love to Develop." ]'>
  ...
  <p class="how2text" align="center">Join.</p>
  <p class="how2text" align="center">&nbsp;</p>
  
<span><input type="submit" name="button3" id="button3" value="GET STARTED" class="bluebutton" ></span>
...
Customer Care 
   ...
   <div class="footerboxa"><img src="images/play.png" width="100%" height="55"><p></p>
   <img src="images/apple.png" width="100%" height="55"></div>
